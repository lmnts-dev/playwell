	...
	<div class="row">
		<div class="col-8 col-content">
			<div class="tsd-panel tsd-typography">
				...
				<pre><code class="lang-javascript">apiEndpoint: your-repo-name.prismic.io/api/v2
</code></pre>
				<h4 id="npm">NPM</h4>
				<pre><code class="lang-sh">npm install prismic-javascript --save
</code></pre>
				<h4 id="cdn">CDN</h4>
				<pre><code><span class="hljs-symbol">https:</span><span class="hljs-comment">//unpkg.com/prismic-javascript</span>
</code></pre><p>(You may need to adapt the version number)</p>
				...
				<pre><code class="lang-javascript"><span class="hljs-keyword">var</span> Prismic = <span class="hljs-built_in">require</span>(<span class="hljs-string">'prismic-javascript'</span>);
...
Prismic.api(<span class="hljs-string">"https://your-repository-name.prismic.io/api"</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">api</span>) </span>{
  ...
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">"Something went wrong: "</span>, err);
				...
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"video"</span> : {
  <span class="hljs-string">"type"</span> : <span class="hljs-string">"Embed"</span>
}
</code></pre>
				<p>Template JS</p>
				<pre><code class="lang-javascript">doc.data.video.embed_url
</code></pre>
				<h4 id="image">Image</h4>
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"photo"</span> : {
  ...
  <span class="hljs-string">"config"</span> : {
    ...
    <span class="hljs-string">"thumbnails"</span> : [ {
      ...
      <span class="hljs-string">"height"</span> : <span class="hljs-number">300</span>
				...
				<p>Template JS</p>
				<pre><code class="lang-javascript"><span class="hljs-comment">//main view</span>
doc.data.photo.url
doc.data.photo.alt
...
doc.data.photo.small.height
				...
				<h4 id="text">Text</h4>
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"title"</span> : {
  <span class="hljs-string">"type"</span> : <span class="hljs-string">"Text"</span>,
}
</code></pre>
				<p>Template JS</p>
				<pre><code class="lang-javascript">doc.data.title
</code></pre>
				<h4 id="number">Number</h4>
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"count"</span> : {
  <span class="hljs-string">"type"</span> : <span class="hljs-string">"Text"</span>,
}
</code></pre>
				<p>Template JS</p>
				<pre><code class="lang-javascript">doc.data.count
</code></pre>
				<h4 id="date">Date</h4>
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"publication"</span> : {
  <span class="hljs-string">"type"</span> : <span class="hljs-string">"Date"</span>,
}
</code></pre>
				<p>Template JS</p>
				<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> { <span class="hljs-built_in">Date</span> } <span class="hljs-keyword">from</span> <span class="hljs-string">'prismic-dom'</span>
...
<span class="hljs-built_in">Date</span>(doc.data.publication)
				...
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"time"</span> : {
...
<span class="hljs-built_in">Date</span>(doc.data.time)
</code></pre>
				<h4 id="select">Select</h4>
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"gender"</span> : {
  <span class="hljs-string">"type"</span> : <span class="hljs-string">"Select"</span>,
}
</code></pre>
				<p>Template JS</p>
				<pre><code class="lang-javascript">doc.data.gender
</code></pre>
				<h4 id="color">Color</h4>
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"background"</span> : {
  <span class="hljs-string">"type"</span> : <span class="hljs-string">"Color"</span>,
}
</code></pre>
				<p>Template JS</p>
				<pre><code class="lang-javascript">doc.data.background
</code></pre>
				<h4 id="richtext">RichText</h4>
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"description"</span> : {
  <span class="hljs-string">"type"</span> : <span class="hljs-string">"StructuredText"</span>,
}
</code></pre>
				<p>Template JS</p>
				<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> { RichText } <span class="hljs-keyword">from</span> <span class="hljs-string">'prismic-dom'</span>
...
RichText.asHtml(doc.data.description, linkResolver)
				...
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"linktoweb"</span> : {
  ...
  <span class="hljs-string">"config"</span> : {
    <span class="hljs-string">"select"</span> : <span class="hljs-string">"web"</span>
				...
				<p>Template JS</p>
				<pre><code class="lang-javascript">doc.data.linktoweb.url
</code></pre>
				<h4 id="documentlink">DocumentLink</h4>
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"linktodoc"</span> : {
  <span class="hljs-string">"type"</span> : <span class="hljs-string">"Link"</span>,
  <span class="hljs-string">"config"</span> : {
    ...
    "tags" : [ &lt;your-tag&gt; ],
				...
				<p>Template JS</p>
				<pre><code class="lang-javascript"><span class="hljs-comment">//return url of the document link</span>
doc.data.linktodoc
...
linkResolver(doc.data.linktodoc)
				...
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"linktomedia"</span> : {
  <span class="hljs-string">"type"</span> : <span class="hljs-string">"Link"</span>,
  <span class="hljs-string">"config"</span> : {
    <span class="hljs-string">"select"</span> : <span class="hljs-string">"media"</span>
				...
				<p>Template JS</p>
				<pre><code class="lang-javascript">doc.data.linktomedia.url
</code></pre>
				<h4 id="filelink">FileLink</h4>
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"linktofile"</span> : {
  <span class="hljs-string">"type"</span> : <span class="hljs-string">"Link"</span>,
  <span class="hljs-string">"config"</span> : {
    <span class="hljs-string">"select"</span> : <span class="hljs-string">"media"</span>
  }
				...
				<p>Template JS</p>
				<pre><code class="lang-javascript">doc.data.linktofile.url
</code></pre>
				<h4 id="group">Group</h4>
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"feature"</span> : {
...
doc.data.feature.forEach(<span class="hljs-function"><span class="hljs-params">item</span> =&gt;</span> {
    ...
    RichText.asHtml(item.description, linkResolver)
				...
				<p>Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"location"</span> : {
  <span class="hljs-string">"type"</span> : <span class="hljs-string">"GeoPoint"</span>,
}
</code></pre>
				<p>Template JS</p>
				<pre><code class="lang-javascript">doc.data.latitude
doc.data.longitude
</code></pre>
				...
				Custom type</p>
				<pre><code class="lang-javascript"><span class="hljs-string">"contentAsSlices"</span> : {
    ...
    <span class="hljs-string">"config"</span> : {
        <span class="hljs-string">"choices"</span> : {
            <span class="hljs-string">"slides"</span> : {
				...
				<p>Template JS</p>
				<pre><code class="lang-javascript"><span class="hljs-keyword">for</span>(slice <span class="hljs-keyword">in</span> doc.data.contentAsSlices) {
