...
function processDocument(doc, options) {
    ...
    var node = __assign({}, withRefs, rawAliases, { id: documentIds_1.safeId(overlayDrafts ? unprefixDraftId_1.unprefixDraftId(doc._id) : doc._id, createNodeId), parent: null, children: [], internal: {
