...
import { start, stop, toEventObject, toActivityDefinition, send, cancel, after, raise, done, doneInvoke, toActionObject, resolveSend, initEvent, toActionObjects } from './actions';
    ...
    StateNode.prototype.next = function (state, eventObject) {
        ...
        try {
            for (var candidates_1 = __values(candidates), candidates_1_1 = candidates_1.next(); !candidates_1_1.done; candidates_1_1 = candidates_1.next()) {
                ...
                if ((!cond || this.evaluateGuard(cond, resolvedContext, eventObject, state)) && isInState) {
        ...
        if (!nextStateStrings.length) {
            return {
                ...
                ? this.machine.getStateTree(state.value) : undefined,
                source: state,
                actions: actions
            };
        }
