...
var Interpreter = /** @class */ (function () {
    ...
    Interpreter.prototype.spawn = function (entity, name) {
    ...
    Interpreter.prototype.spawnMachine = function (machine, options) {
        ...
        if (options.subscribe) {
            childService.onTransition(function (state) {
                _this.send(actionTypes.update, { state: state, id: childService.id }); // TODO: actionTypes
            });
        }
        childService
        ...
        var actor = {
            ...
            subscribe: function (next, handleError, complete) {
                promise
                    ...
                    .catch(handleError);
                return {
                    unsubscribe: function () { return (canceled = true); }
                };
            },
            stop: function () {
                canceled = true;
    ...
    Interpreter.prototype.spawnCallback = function (callback, id) {
        ...
        try {
            ...
            this.send(actions_1.error(err, id));
        }
        var actor = {
            id: id,
    ...
    Interpreter.prototype.spawnObservable = function (source, id) {
        ...
        var subscription = source.subscribe(function (value) {
            ...
            _this.send(actions_1.error(err, id));
        }, function () {
...
var nullActor = {
    ...
    toJSON: function () { return ({ id: 'null' }); }
};
function spawn(entity, name) {
    return withServiceScope(undefined, function (service) {
        ...
        if (service) {
            return service.spawn(entity, name || utils_1.uniqueId());
        }
        else {
            return nullActor;
        }
