 ...
 */
export declare type InvokeCreator<TFinalContext, TContext> = (context: TContext, event: EventObject) => PromiseLike<TFinalContext> | StateMachine<TFinalContext, any, any> | Subscribable<any> | InvokeCallback;
