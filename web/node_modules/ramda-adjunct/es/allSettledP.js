...
export var allSettledPPolyfill = curry1(polyfill);
/**
...
var allSettledP = isFunction(Promise.allSettled) ? curry1(bind(Promise.allSettled, Promise)) : allSettledPPolyfill;
