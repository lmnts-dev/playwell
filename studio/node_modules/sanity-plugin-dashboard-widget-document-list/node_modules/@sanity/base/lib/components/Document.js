...
function Document(props) {
  ...
  var staticPath = `${basePath}${props.staticPath}`;
  var stylesheets = props.stylesheets.map(item => _react.default.createElement("link", {
    key: item.path,
    rel: "stylesheet",
    href: assetUrl(staticPath, item)
  }));
  var subresources = props.scripts.map(item => _react.default.createElement("link", {
    key: item.path,
    rel: "subresource",
    href: assetUrl(staticPath, item)
  }));
  ...
  var favicons = props.favicons.map((item, index) => _react.default.createElement("link", {
    key: item.path,
    rel: "icon",
    href: assetUrl(staticPath, item)
  }));
