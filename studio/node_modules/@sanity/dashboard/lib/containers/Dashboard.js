...
function Dashboard(props) {
  ...
  var widgetConfigs = _config.default.widgets || [];
  return _react.default.createElement(_DashboardLayout.default, null, _react.default.createElement(_WidgetGroup.default, {
    config: {
