...
class Asset extends _react.default.PureComponent {
  ...
  render() {
    ...
    return _react.default.createElement("a", {
      ...
      }, filteredDocuments.length > 1 ? "".concat(filteredDocuments.length, " documents are using this asset") : 'A document is using this asset'), _react.default.createElement("p", {
        className: _Asset.default.referringDocumentsDescription
      }, "Open the document".concat(referringDocuments.length > 1 ? 's' : '', " and remove the asset before deleting it."))), _react.default.createElement(_default2.List, null, filteredDocuments.map(doc => {
