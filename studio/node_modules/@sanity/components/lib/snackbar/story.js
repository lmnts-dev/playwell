...
var Provider = storyFn => _react.default.createElement(_sanity.default, {
  part: "part:@sanity/components/snackbar/item",
  propTables: [_item.default]
}, _react.default.createElement(_provider.default, null, storyFn()));
...
(0, _storybook.storiesOf)('Snackbar', module).add('Default', () => _react.default.createElement(_item.default, _extends({}, globalDefaults, {
...
}))).add('Custom icon', () => _react.default.createElement(_item.default, _extends({}, globalDefaults, {
  kind: (0, _knobs.select)('Kind', ['success', 'error', 'warning', 'info'], 'info', 'props'),
  title: (0, _knobs.text)('Title', 'This is a title placeholder', 'props'),
  subtitle: (0, _knobs.text)('Subtitle', '', 'props'),
...
}))).add('Custom onClose', () => _react.default.createElement(_item.default, _extends({}, globalDefaults, {
  kind: (0, _knobs.select)('Kind', ['success', 'error', 'warning', 'info'], 'info', 'props'),
  title: (0, _knobs.text)('Title', 'This is a title placeholder', 'props'),
  subtitle: (0, _knobs.text)('Subtitle', '', 'props'),
...
}))).add('Stacked', () => _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_item.default, _extends({}, globalDefaults, {
  kind: "info",
  title: (0, _knobs.text)('title', 'This is a title placeholder', 'props'),
  isCloseable: (0, _knobs.boolean)('isCloseable', true, 'props'),
  icon: true
})), _react.default.createElement(_item.default, _extends({}, globalDefaults, {
  offset: 75,
  kind: "warning",
  title: (0, _knobs.text)('title', 'This is a title placeholder', 'props'),
  isCloseable: (0, _knobs.boolean)('isCloseable', true, 'props'),
...
})))).add('With children', () => _react.default.createElement(_item.default, _extends({}, globalDefaults, {
  kind: (0, _knobs.select)('Kind', ['success', 'error', 'warning', 'info'], 'info', 'props'),
  title: (0, _knobs.text)('Title', 'This is a title placeholder', 'props'),
  subtitle: (0, _knobs.text)('Subtitle', '', 'props'),
  ...
  onClose: action((0, _knobs.text)('onClose', 'Custom onClose', 'props'))
}), _react.default.createElement("div", null, (0, _knobs.text)('Children', 'This is the children placeholder', 'props')))).add('Transitions', () => {
  ...
  return _react.default.createElement(SnackQueue, {
    snack: snack
  });
});